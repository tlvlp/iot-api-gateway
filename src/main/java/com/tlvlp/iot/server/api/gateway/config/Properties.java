...
public class Properties {
    ...
    @Value("${SCHEDULER_SERVICE_API_POST_MQTT_MESSAGE_SEND_EVENT}")
    private String SCHEDULER_SERVICE_API_POST_MQTT_MESSAGE_SEND_EVENT;
    ...
    public String getSCHEDULER_SERVICE_API_POST_MQTT_MESSAGE_SEND_EVENT() {
        return SCHEDULER_SERVICE_API_POST_MQTT_MESSAGE_SEND_EVENT;
    }
